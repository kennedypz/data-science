...
dataset = shuffle(pd.read_csv(
    'deep_learning/data/data_banknote_authentication.txt'))
...
# Applying parameters adjustments in the algorithm
...
for i in range(epochs):
    ...
    output_weights = np.dot(
        l4_out.T, final_sigmoid_derivative) / actual_out_size
